...
Proof.
  ...
  destruct 1.
  - (* Aha! Rocq remembered that we had a value on the left-hand sidde of the
       step *)
...
(* The (non-recursive) eliminator for step in Rocq *)
...
(* An inversion operator for step in Rocq *)
